...
if(isset($_GET['Delete']))
{
    ...
    $stm = "DELETE FROM userbook WHERE id=$bookid";
    try{
  ...
  <section class="client_section layout_padding">
    <div class="container ">
      ...
      <div class="row">
        ...
        $sql="SELECT * FROM book,userbook WHERE book.id = userbook.bookid AND userbook.userid=".$userid;
             ...
             <div class='client_id'>
               ...
               <div class='client_name'>
                ...
                ".$category['description']."
                 ...
                 <form action='userbook.php' >
                 <input type='hidden' name='bookid' id='bookid' value = '". $category['id']."'/><br><br>
