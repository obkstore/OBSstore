...
if(isset($_POST['submit']))
{
    ...
    if(!$data)
    {
      ...
      else
      {
        ...
        if($category["type"] == "manager")
        {
          header("Location: manager.php?username=". $username);
        }
        else
        {
          header("Location: home.php?userid=". $category["id"]);
        }
      ...
      <div class="row">
        <div class="col-md-6 ">
          ...
          <form action="login.php" method="POST">
            ...
            <div>
            <input type="password" id="password" name="password" onmouseleave="chkName()" placeholder="Password..."/>
              </div>
            
            <div >
             <input class="send" type="submit" value="Login" name="submit" id="submit"\>
            </div>
            <div >
